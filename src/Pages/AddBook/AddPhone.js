...
const AddPhone = () => {
  ...
  const handleBooks = (event) => {
    ...
    fetch("https://resale-assingment-server.vercel.app/addphone", {
      method: "POST",
      headers: {
        ...
        <div className="card-body">
          ...
          <div className="form-control">
            ...
            <input
              ...
              name="image"
              placeholder="image"
              className="input input-bordered w-200 h-200"
            />
          </div>
          <div className="form-control">
            <label className="label">
...
//         fetch('https://resale-assingment-server.vercel.app/addbooks',{
//             method:'POST',
//             headers:{
//                 'content-type' : 'application/json'
//             },
